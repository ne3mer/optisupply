    ...
    >
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg, transparent, rgba(200,240,90,0.6), transparent)",
        }}
      />
        ...
        >
          <div className="lp-nav-inner">
            ...
            <div className="lp-nav-links">
              ...
              <a href="#numbers" className="lp-nav-link">
                Numbers
              </a>
              <Link
                to="/dashboard"
                className="lp-cta-outline lp-nav-cta"
        ...
        <section className="lp-hero">
          ...
          <div
            style={{
              ...
              height: 600,
              background:
                "radial-gradient(circle, rgba(200,240,90,0.05) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <div
              style={{
                ...
                marginBottom: 28,
                opacity: 0,
                animation: "lp-fadeup 0.7s ease 0.1s forwards",
              }}
            >
            ...
            <h1
              style={{
                ...
                marginBottom: 28,
                opacity: 0,
                animation: "lp-fadeup 0.8s ease 0.2s forwards",
              }}
            >
            ...
            <p
              style={{
                ...
                marginBottom: 40,
                opacity: 0,
                animation: "lp-fadeup 0.8s ease 0.35s forwards",
              }}
            >
              OptiSupply turns supply chain complexity into clarity — real-time
              ESG scoring, geo-risk intelligence, and AI-driven supplier
            ...
            <div
              style={{
                ...
                gap: 24,
                opacity: 0,
                animation: "lp-fadeup 0.8s ease 0.65s forwards",
              }}
            >
              {[
          ...
          <div
            ...
            style={{
              opacity: 0,
              animation: "lp-fadeup 0.9s ease 0.45s forwards",
            }}
          >
            <DashPreview />
            <div
            ...
            {[
              ...
              },
              {
                ...
                icon: (
                  <svg
                    ...
                    strokeWidth="1.5"
                  >
                    <path d="M9 19v-6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2zm0 0V9a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v10m-6 0a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2m0 0V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v14" />
                  </svg>
                ),
                title: "Score & Analyze",
              ...
              <Reveal key={s.step} delay={i * 100} style={{ background: BG2 }}>
                ...
                >
                  ...
                  <div
                    style={{ color: "rgba(255,255,255,0.4)", marginBottom: 20 }}
                  >
                    {s.icon}
                  </div>
                  <h3
          ...
          <div className="lp-features-grid">
            ...
            <Reveal className="lp-features-big">
              ...
              >
                ...
                >
                  Live ESG scoring across 12,000+ suppliers. Geo-risk overlays
                  show political instability, environmental exposure and labour
                  violations — updated continuously from 400+ data sources.
                </p>
                <Link
                  to="/dashboard"
        ...
        <section className="lp-section-pad" style={{ background: BG }}>
          <div style={{ maxWidth: 840, margin: "0 auto" }}>
            <Reveal>
              ...
              >
                "OptiSupply didn't just give us visibility — it gave us the
                confidence to make supply chain decisions that used to require a
                team of analysts. The ESG scoring alone has transformed our
                procurement process."
              </blockquote>
