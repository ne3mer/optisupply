...
// Import Supplier model (using require for CommonJS compatibility)
...
const generateCompanyName = (industry: string, index: number): string => {
...
const generateSupplier = (industry: string, index: number) => {
